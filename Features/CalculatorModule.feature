Feature: Calculator Module
  ...
  @Add
  Scenario: Test Case to verify Addition functionality using given calculator application
  ...
  @Sub
  Scenario: Test Case to verify Subtraction functionality using given calculator application
  ...
  @Mul
  Scenario: Test Case to verify Multiplication functionality using given calculator application
